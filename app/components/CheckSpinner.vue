<template>
  <svg viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M43.9359 29.5111L34.811 43.197C34.3261 43.9227 33.3467 44.1237 32.6193 43.6349L28.2769 39.3362C26.8372 37.8964 29.0747 35.6606 30.5087 37.1044L33.2509 39.8408L41.3041 27.7551C42.4333 26.0612 45.0673 27.8188 43.9359 29.5111Z" fill="black"/>
  </svg>
</template>
